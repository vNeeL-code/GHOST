...
3. Download a [Gemma 4 model](https://huggingface.co/google/gemma-4-E2B-it) (via Google AI Edge Gallery or manually place `.litertlm` or `.task` variant in app storage via drag and drop.).  
4. **Shake to summon.**  

...
class SystemToolSet(private val context: Context) : ToolSet {
    ...
    fun take_screenshot(): Map<String, String> {
        return try {
            val intent = Intent(context, com.ghost.api.GemmaService::class.java).apply {
                action = "com.ghost.api.ACTION_REQUEST_SCREENSHOT"
            }
    ...
    fun resources_screen(): Map<String, String> {
        val dump = com.ghost.api.GemmaAccessibilityService.instance?.getSemanticScreenDump() ?: "Accessibility Service not bound."

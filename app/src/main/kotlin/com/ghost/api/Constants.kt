...
object Constants {
    ...
    const val PREF_PIP_VISIBILITY = "pip_visibility_enabled" // Deprecated: replaced by headless work signal
    const val PREF_WORK_SIGNAL_ENABLED = "work_signal_enabled"
